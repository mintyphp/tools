...
class TranslatorTool
{
    ...
    private function getFormHtml(): string
    {
        ...
        $html[] = '<li><strong>Actual Translation:</strong> Use the external tool <a href="https://poedit.net/">Poedit</a> to translate the .pot file into a .po file per language.</li>';
